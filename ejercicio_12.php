...
//12 CALCULO DE BECAS DE ESTUDIANTES
...
<body>
    <header>
        ...
        <img src="honda-bros-1.jpeg" width="700" height="182" />
    </header>
    <section>
        ...
        <form name="frmPension" method="POST">
            ...
            <table width="700" cellspacing="5" cellpadding="1">
                <tr>
                    <td>Alumno</td>
                    <td><input type="text" name="txtAlumno" size="70" value="<?php echo getAlumno(); ?>" /></td>
                    <td></td>
                </tr>
                <tr>
                ...
                <table width="700" cellspacing="1" cellpadding="1">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php 
                                echo 'Bs. ' . number_format($pension($categoria(getPromedio())), '2', '.', ''); 
                                ?>
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
                        ...
                        <td>
                            <?php 
                            echo 'Bs. ' . number_format($montoTotal, '2', '.', ''); 
                            ?>
                        </td>
                    </tr>
                </table>
