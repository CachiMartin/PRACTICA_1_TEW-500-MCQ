...
echo "<b>Estudiante:</b>M,ARTIN CACHI QUISPE<br>";
echo "<b>PRACTICA # 1</b><br>";
echo "---------------------------------------------------------------<br>";
echo "<h1>Ejercicio - 13</h1><br>";
echo "Listado de productos con paginacion.<br>";
?>
<!DOCTYPE html>
<html>
<head>
...
function paginar($misProductos, $total, $pagina)
{
    ...
    for ($i = $inicio; $i < $final; $i++) {
        list($producto, $precio) = array(key($paginado), current($paginado)); 
        next($paginado);
