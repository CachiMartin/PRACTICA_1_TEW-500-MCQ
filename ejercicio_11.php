...
echo "<b>Estudiante:</b>MARTIN CACHI QUISPE<br>";
echo "<b>PRACTICA # 1</b><br>";
echo "---------------------------------------------------------------<br>";
echo "<h1>Ejercicio - 11</h1><br>";
...
<body>
    <header>
        ...
        <img src="IMG20230301131007.jpg" width="660" height="200" />
        <br>
    </header>
    <section>
        <?php
                    ...
                    <td colspan="2">
                        <table width="650" cellspacing="2" cellpadding="2">
                            <tr>
                                ...
                                <td width="179">
                                    <input type="text" name="txtNota1" size="5" value="<?php echo $nota1; ?>" />
                                </td>
                                <td width="179" id="error"><?php echo $mNota1; ?></td>
                                <td width="179">Nota 2</td>
                                <td width="179">
                                    <input type="text" name="txtNota2" size="5" value="<?php echo $nota2; ?>" />
                                </td>
                                <td width="179" id="error"><?php echo $mNota2; ?></td>
                            </tr>
                            <tr>
                                <td>Nota 3</td>
                                <td><input type="text" name="txtNota3" size="5" value="<?php echo $nota3; ?>" />
                                </td>
                                <td id="error"><?php echo $mNota3; ?></td>
                                <td>Nota 4</td>
                                <td><input type="text" name="txtNota4" size="5" value="<?php echo $nota4; ?>" />
                                </td>
    ...
    <footer>
       <h3 id="centrado">Todos los derechos reservados - By CACHI</h3>
    </footer>
</body>
